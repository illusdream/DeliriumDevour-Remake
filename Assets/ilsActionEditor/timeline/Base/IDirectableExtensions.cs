...
{
    /// <summary>
    /// 对<see cref="IDirectable"/>接口的拓展方法
    /// </summary>
    public static class IDirectableExtensions
    {

        ///<summary>directable的长度</summary>
        public static float GetLength(this IDirectable directable) {
            return directable.endTime - directable.startTime;
        }

        public static int GetLogicFrameLength(this ILogicDirectable directable)
        {
            return directable.endFrame - directable.startFrame;
        }

        ///<summary>基于根当前时间的可定向对象的本地时间</summary>
        ...
        public static int GetLogicFrameCount(this IDirectable directable,float rootTime)
        {
            return Mathf.CeilToInt(rootTime / 0.02f);
        }
        
        public static int ToLocalLogicFrameCount(this IDirectable directable,ILogicDirectable logicDirectable,float time)
        {
            var totalFrameCount = directable.GetLogicFrameCount(time);
            return Mathf.Clamp(totalFrameCount - logicDirectable.startFrame,0,logicDirectable.GetLogicFrameLength());
        }
        ...
        public static bool CanBlendIn(this IDirectable directable) {
            ...
            return blendInProp != null && blendInProp.CanWrite && directable.blendIn != -1 && blendInProp.DeclaringType != typeof(BaseActionClip);
        }
        ...
        public static bool CanBlendOut(this IDirectable directable) {
            ...
            return blendOutProp != null && blendOutProp.CanWrite && directable.blendOut != -1 && blendOutProp.DeclaringType != typeof(BaseActionClip);
        }
        ...
        public static bool CanScale(this IDirectable directable) {
            ...
            return lengthProp != null && lengthProp.CanWrite && lengthProp.DeclaringType != typeof(BaseActionClip);
        }
        ...
        public static bool TryAutoKey(this IKeyable keyable, float time) {
            ...
            var case1 = ReferenceEquals(Selection.activeObject, keyable);
