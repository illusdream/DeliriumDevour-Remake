                ...
                for ( var k = 0; k < curveX.length; k++ ) {
                    ...
                    if ( contextAction != ContextAction.None && k == kIndex ) {
                        ...
                        if ( _contextAction == ContextAction.SetBrokenMode ) {
                            Undo.RecordObject(serializeContext, "Animation Curve Change");
                             CurveUtility.SetKeyBroken(curveX, kIndex, contextBrokenMode);
                             CurveUtility.SetKeyBroken(curveY, kIndex, contextBrokenMode);
                             CurveUtility.SetKeyBroken(curveZ, kIndex, contextBrokenMode);
                    ...
                    if ( kIndex == k ) {
                        if ( Tools.current == Tool.Move ) {
                            ...
                            var fmh_195_68_638830087628486929 = Quaternion.identity; newValue = Handles.FreeMoveHandle(pos, pointSize, Vector3.zero, Handles.RectangleHandleCap);
                        }
                    }
                    ...
                    if ( haveSameTangents && tangentMode ==  TangentMode.Editable ) {
                        ...
                        if ( kIndex == k ) {
                            ...
                            if ( k != 0 ) {
                                ...
                                var fmh_223_84_638830087628491816 = Quaternion.identity; var newInHandle = Handles.FreeMoveHandle(inHandle, handleSize, Vector3.zero, Handles.CircleHandleCap);
                            ...
                            if ( k < curveX.length - 1 ) {
                                ...
                                var fmh_249_86_638830087628496133 = Quaternion.identity; var newOutHandle = Handles.FreeMoveHandle(outHandle, handleSize, Vector3.zero, Handles.CircleHandleCap);
