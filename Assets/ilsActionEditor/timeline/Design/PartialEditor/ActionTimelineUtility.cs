...
{
    public static class ActionTimelineUtility
    {
        ...
        [System.NonSerialized]
        public static Dictionary<AnimatedParameter, ActionTimelineUtility.ChangedParameterCallbacks> changedParameterCallbacks = new Dictionary<AnimatedParameter, ActionTimelineUtility.ChangedParameterCallbacks>();
        ...
        public static void CopyClip(BaseActionClip clip) {
            copyJson = JsonUtility.ToJson(clip, false);
            copyType = clip.GetType();
        }

        ///<summary>Cut a clip</summary>
        public static void CutClip(BaseActionClip clip) {
            copyJson = JsonUtility.ToJson(clip, false);
            copyType = clip.GetType();
        ...
        public static BaseActionClip PasteClip(BaseActionTrack track, float time) {
		...
		public static void CopyClipValues(BaseActionClip clip) {
        ...
        public static void PasteClipValues(BaseActionClip clip) {
